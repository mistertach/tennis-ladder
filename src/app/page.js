                    ...
                    <div className={styles.mainContent}>
                        ...
                        <div className={styles.infoCard}>
                            ...
                            <ul className={styles.rulesList}>
                                ...
                                <li><strong>Court Access:</strong> Aramcons (and dependents, retirees, JHAH employees with camp access) can play free from 5 a.m. to 10 p.m. Reserve courts 1, 6, 14 at the Hills and 10, 11 at 3rd street via the myCommunity app (<a href="https://apps.apple.com/sa/app/mycommunity-sa/id1588032644" target="_blank" style={{ textDecoration: 'underline', color: 'var(--primary-color)' }}>iOS</a> / <a href="https://play.google.com/store/apps/details?id=com.aramco.myCommunity&hl=en" target="_blank" style={{ textDecoration: 'underline', color: 'var(--primary-color)' }}>Android</a>).</li>
                            </ul>
                            <div style={{ marginTop: '1.5rem', borderRadius: '8px', overflow: 'hidden', border: '1px solid var(--border-color)' }}>
                                <iframe src="https://www.google.com/maps/d/embed?mid=1Xw3z3XrfK9o1ffVbi2COeDj3MwjpYrE" width="100%" height="350" style={{ border: 0, display: 'block' }}></iframe>
                            </div>
                        </div>
