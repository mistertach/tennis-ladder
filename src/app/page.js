                    ...
                    <div className={styles.mainContent}>
                        ...
                        <div className={styles.infoCard}>
                            ...
                            <ul className={styles.rulesList}>
                                ...
                                <li><strong>Court Access:</strong> Aramcons (and dependents, retirees, JHAH employees with camp access) can play free from 5 a.m. to 10 p.m. Reserve courts 1, 6, 14 at the <a href="https://maps.apple.com/?ll=26.311753,50.134706" target="_blank" style={{ textDecoration: 'underline', color: 'var(--primary-color)' }}>Hills</a> and 10, 11 at <a href="https://maps.apple.com/?ll=26.318353,50.141977" target="_blank" style={{ textDecoration: 'underline', color: 'var(--primary-color)' }}>3rd street</a> via the myCommunity app (<a href="https://apps.apple.com/sa/app/mycommunity-sa/id1588032644" target="_blank" style={{ textDecoration: 'underline', color: 'var(--primary-color)' }}>iOS</a> / <a href="https://play.google.com/store/apps/details?id=com.aramco.myCommunity&hl=en" target="_blank" style={{ textDecoration: 'underline', color: 'var(--primary-color)' }}>Android</a>).</li>
                            </ul>
                        </div>
